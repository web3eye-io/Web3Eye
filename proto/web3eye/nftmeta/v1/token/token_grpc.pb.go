...
const (
	Manager_CreateToken_FullMethodName       = "/nftmeta.v1.token.Manager/CreateToken"
	Manager_CreateTokens_FullMethodName      = "/nftmeta.v1.token.Manager/CreateTokens"
	Manager_UpdateToken_FullMethodName       = "/nftmeta.v1.token.Manager/UpdateToken"
	Manager_UpsertToken_FullMethodName       = "/nftmeta.v1.token.Manager/UpsertToken"
	Manager_UpdateImageVector_FullMethodName = "/nftmeta.v1.token.Manager/UpdateImageVector"
	Manager_GetToken_FullMethodName          = "/nftmeta.v1.token.Manager/GetToken"
	Manager_GetTokenOnly_FullMethodName      = "/nftmeta.v1.token.Manager/GetTokenOnly"
...
func (c *managerClient) CreateTokens(ctx context.Context, in *CreateTokensRequest, opts ...grpc.CallOption) (*CreateTokensResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_CreateTokens_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) UpsertToken(ctx context.Context, in *UpsertTokenRequest, opts ...grpc.CallOption) (*UpsertTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_UpsertToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) UpdateImageVector(ctx context.Context, in *UpdateImageVectorRequest, opts ...grpc.CallOption) (*UpdateImageVectorResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_UpdateImageVector_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Manager_CreateTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_CreateTokens_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Manager_UpsertToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_UpsertToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Manager_UpdateImageVector_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_UpdateImageVector_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
