...
func (bq *BlockQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (bq *BlockQuery) FirstIDX(ctx context.Context) uint32 {
...
func (bq *BlockQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (bq *BlockQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (bq *BlockQuery) IDs(ctx context.Context) ([]uint32, error) {
	var ids []uint32
...
func (bq *BlockQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := bq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (bq *BlockQuery) prepareQuery(ctx context.Context) error {
	...
	if block.Policy == nil {
		return errors.New("ent: uninitialized block.Policy (forgotten import ent/runtime?)")
	}
...
func (bq *BlockQuery) ForUpdate(opts ...sql.LockOption) *BlockQuery {
...
func (bq *BlockQuery) ForShare(opts ...sql.LockOption) *BlockQuery {
	if bq.driver.Dialect() == dialect.Postgres {
		bq.Unique(false)
	}
	bq.modifiers = append(bq.modifiers, func(s *sql.Selector) {
...
func (bq *BlockQuery) Modify(modifiers ...func(s *sql.Selector)) *BlockSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (bs *BlockSelect) Modify(modifiers ...func(s *sql.Selector)) *BlockSelect {
