...
var file_web3eye_ranker_v1_transfer_transfer_proto_rawDesc = []byte{
	...
	0x2f, 0x76, 0x31, 0x2f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x2f, 0x74, 0x72, 0x61,
	0x6e, 0x73, 0x66, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xb1, 0x03, 0x0a, 0x07,
	0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x12, 0x62, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x54, 0x72,
	...
	0x22, 0x00, 0x12, 0x6b, 0x0a, 0x0e, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73,
	0x66, 0x65, 0x72, 0x73, 0x12, 0x2a, 0x2e, 0x6e, 0x66, 0x74, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x76,
	0x31, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x2e, 0x43, 0x6f, 0x75, 0x6e, 0x74,
...
var file_web3eye_ranker_v1_transfer_transfer_proto_depIdxs = []int32{
	0, // 0: ranker.v1.transfer.Manager.GetTransfer:input_type -> nftmeta.v1.transfer.GetTransferRequest
	1, // 1: ranker.v1.transfer.Manager.GetTransferOnly:input_type -> nftmeta.v1.transfer.GetTransferOnlyRequest
	2, // 2: ranker.v1.transfer.Manager.GetTransfers:input_type -> nftmeta.v1.transfer.GetTransfersRequest
	3, // 3: ranker.v1.transfer.Manager.CountTransfers:input_type -> nftmeta.v1.transfer.CountTransfersRequest
	4, // 4: ranker.v1.transfer.Manager.GetTransfer:output_type -> nftmeta.v1.transfer.GetTransferResponse
	5, // 5: ranker.v1.transfer.Manager.GetTransferOnly:output_type -> nftmeta.v1.transfer.GetTransferOnlyResponse
	6, // 6: ranker.v1.transfer.Manager.GetTransfers:output_type -> nftmeta.v1.transfer.GetTransfersResponse
	7, // 7: ranker.v1.transfer.Manager.CountTransfers:output_type -> nftmeta.v1.transfer.CountTransfersResponse
