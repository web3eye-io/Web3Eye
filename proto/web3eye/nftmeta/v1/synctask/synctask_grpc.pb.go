...
const (
	Manager_CreateSyncTask_FullMethodName     = "/nftmeta.v1.synctask.Manager/CreateSyncTask"
	Manager_TriggerSyncTask_FullMethodName    = "/nftmeta.v1.synctask.Manager/TriggerSyncTask"
	Manager_UpdateSyncTask_FullMethodName     = "/nftmeta.v1.synctask.Manager/UpdateSyncTask"
	Manager_GetSyncTask_FullMethodName        = "/nftmeta.v1.synctask.Manager/GetSyncTask"
	Manager_GetSyncTaskOnly_FullMethodName    = "/nftmeta.v1.synctask.Manager/GetSyncTaskOnly"
	Manager_GetSyncTasks_FullMethodName       = "/nftmeta.v1.synctask.Manager/GetSyncTasks"
	Manager_ExistSyncTask_FullMethodName      = "/nftmeta.v1.synctask.Manager/ExistSyncTask"
	Manager_ExistSyncTaskConds_FullMethodName = "/nftmeta.v1.synctask.Manager/ExistSyncTaskConds"
	Manager_CountSyncTasks_FullMethodName     = "/nftmeta.v1.synctask.Manager/CountSyncTasks"
	Manager_DeleteSyncTask_FullMethodName     = "/nftmeta.v1.synctask.Manager/DeleteSyncTask"
)
...
func (c *managerClient) TriggerSyncTask(ctx context.Context, in *TriggerSyncTaskRequest, opts ...grpc.CallOption) (*TriggerSyncTaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_TriggerSyncTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) GetSyncTaskOnly(ctx context.Context, in *GetSyncTaskOnlyRequest, opts ...grpc.CallOption) (*GetSyncTaskOnlyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_GetSyncTaskOnly_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) ExistSyncTask(ctx context.Context, in *ExistSyncTaskRequest, opts ...grpc.CallOption) (*ExistSyncTaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_ExistSyncTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) ExistSyncTaskConds(ctx context.Context, in *ExistSyncTaskCondsRequest, opts ...grpc.CallOption) (*ExistSyncTaskCondsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_ExistSyncTaskConds_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) CountSyncTasks(ctx context.Context, in *CountSyncTasksRequest, opts ...grpc.CallOption) (*CountSyncTasksResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_CountSyncTasks_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Manager_TriggerSyncTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_TriggerSyncTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Manager_GetSyncTaskOnly_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_GetSyncTaskOnly_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Manager_ExistSyncTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_ExistSyncTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Manager_ExistSyncTaskConds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_ExistSyncTaskConds_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Manager_CountSyncTasks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_CountSyncTasks_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
