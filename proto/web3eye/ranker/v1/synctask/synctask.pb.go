...
func (x *UpdateSyncTaskRequest) GetID() uint32 {
	if x != nil {
		return x.ID
	}
	return 0
...
func (x *GetSyncTasksRequest) GetID() uint32 {
	if x != nil && x.ID != nil {
		return *x.ID
	}
	return 0
...
var file_web3eye_ranker_v1_synctask_synctask_proto_rawDesc = []byte{
	...
	0x74, 0x12, 0x13, 0x0a, 0x02, 0x49, 0x44, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x00, 0x52,
