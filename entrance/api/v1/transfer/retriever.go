...
func (s *Server) GetTransfers(ctx context.Context, in *transferpool.GetTransfersRequest) (*transferpool.GetTransfersResponse, error) {
	client.UseCloudProxyCC()
	return client.GetTransfers(ctx, in)
}

func (s *Server) CountTransfers(ctx context.Context, in *transferpool.CountTransfersRequest) (*transferpool.CountTransfersResponse, error) {
	client.UseCloudProxyCC()
