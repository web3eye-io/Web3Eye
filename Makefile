...
PROJECTS=  nft-meta block-etl cloud-proxy gateway ranker gen-car image-converter dealer retriever webui
GO_PROJECTS=  nft-meta block-etl cloud-proxy gateway ranker gen-car dealer retriever
