...
const (
	Manager_Version_FullMethodName          = "/cloudproxy.v1.Manager/Version"
	Manager_GrpcProxyChannel_FullMethodName = "/cloudproxy.v1.Manager/GrpcProxyChannel"
	Manager_GrpcProxy_FullMethodName        = "/cloudproxy.v1.Manager/GrpcProxy"
)
...
func (c *managerClient) GrpcProxyChannel(ctx context.Context, opts ...grpc.CallOption) (Manager_GrpcProxyChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &Manager_ServiceDesc.Streams[0], Manager_GrpcProxyChannel_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *managerClient) GrpcProxy(ctx context.Context, in *GrpcProxyRequest, opts ...grpc.CallOption) (*GrpcProxyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_GrpcProxy_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Manager_GrpcProxy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_GrpcProxy_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
